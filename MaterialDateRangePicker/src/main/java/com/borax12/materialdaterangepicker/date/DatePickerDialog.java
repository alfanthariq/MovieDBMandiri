...
public class DatePickerDialog extends DialogFragment implements
        ...
        tabHost.setOnTabChangedListener(new TabHost.OnTabChangeListener() {
            ...
            public void onTabChanged(String tabId) {
                ...
                if(tabId.equals("start")){
                    ...
                    okButton.setText("OK");
                    setMinDateEnd(mCalendar);
                    if (mCalendarEnd.getTime().before(mCalendar.getTime())) {
                    ...
                    mDayPickerViewEnd.goTo(calendarDay,false,true,true);
                }
            }
        });
        return view;
    ...
    void setMinDateEnd(Calendar calendar) {
        mMinDateEnd = calendar;
//        if (mCalendarEnd.getTime().before(calendar.getTime()))
//        mCalendarEnd = calendar;
    ...
    public Calendar getMinDate() {
        if (isFrom) return mMinDate; else return mMinDateEnd;
        //return mMinDate;
    }

    @Override
    public Calendar getMinDateEnd() {
        return mMinDateEnd;
    }
    /**
